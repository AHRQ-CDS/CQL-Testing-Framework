...
The CQL Testing Framework is a [Node.js module](https://nodejs.org/api/modules.html).  For the beta release, it is distributed as a compressed file: `cql-testing-v1.0.0-beta.1.tgz`. If you've downloaded the cql-testing source code, you'll find a copy of this file in the `dist/` folder.
...
```json
{
  ...
  "devDependencies": {
    "mocha": "^5.2.0",
    "cql-testing": "file:./cql-testing-v1.0.0-beta.1.tgz"
  }
}
```
